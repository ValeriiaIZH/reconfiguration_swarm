...
% функция подсчёта расстояния между двумя отрезками
...
%
%    1
% Взято отсюда: http://www.mathworks.com/matlabcentral/fileexchange/32487-shortest-distance-between-two-line-segments/content/DistBetween2Segment.m
